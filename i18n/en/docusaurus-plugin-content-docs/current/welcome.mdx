...
# Welcome to QE-to-TCAD

**QE-to-TCAD** is a pipeline that transforms **Quantum ESPRESSO** quantum simulations into data usable by **TCAD** (Technology Computer-Aided Design) device simulators.
...
**QE-to-TCAD automates this entire workflow** and ensures physical consistency of results.
